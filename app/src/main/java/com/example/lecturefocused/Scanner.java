...
import com.example.lecturefocused.ui.home.HomeFragment;
            ...
            mCodeScanner.setDecodeCallback(new DecodeCallback() {
                ...
                public void onDecoded(@NonNull @NotNull Result result) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Intent i =new Intent(Scanner.this, attend_lecture.class);
                            Intent codes = i.putExtra("codes", result.getText());
                            startActivity(i);
